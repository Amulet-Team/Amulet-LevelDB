...
cdef PFNleveldb_openPROC leveldb_open = <PFNleveldb_openPROC> get_function(lib_path, b"leveldb_open")

ctypedef void (*PFNleveldb_closePROC)(leveldb_t * db)
cdef PFNleveldb_closePROC leveldb_close = <PFNleveldb_closePROC> get_function(lib_path, b"leveldb_close")
...
cdef PFNleveldb_putPROC leveldb_put = <PFNleveldb_putPROC> get_function(lib_path, b"leveldb_put")
...
cdef PFNleveldb_deletePROC leveldb_delete = <PFNleveldb_deletePROC> get_function(lib_path, b"leveldb_delete")
...
cdef PFNleveldb_writePROC leveldb_write = <PFNleveldb_writePROC> get_function(lib_path, b"leveldb_write")
...
cdef PFNleveldb_getPROC leveldb_get = <PFNleveldb_getPROC> get_function(lib_path, b"leveldb_get")

ctypedef leveldb_iterator_t * (*PFNleveldb_create_iteratorPROC)(leveldb_t * db, const leveldb_readoptions_t * options)
cdef PFNleveldb_create_iteratorPROC leveldb_create_iterator = <PFNleveldb_create_iteratorPROC> get_function(lib_path, b"leveldb_create_iterator")

ctypedef const leveldb_snapshot_t * (*PFNleveldb_create_snapshotPROC)(leveldb_t * db)
cdef PFNleveldb_create_snapshotPROC leveldb_create_snapshot = <PFNleveldb_create_snapshotPROC> get_function(lib_path, b"leveldb_create_snapshot")

ctypedef void (*PFNleveldb_release_snapshotPROC)(leveldb_t * db, const leveldb_snapshot_t * snapshot)
cdef PFNleveldb_release_snapshotPROC leveldb_release_snapshot = <PFNleveldb_release_snapshotPROC> get_function(lib_path, b"leveldb_release_snapshot")
...
cdef PFNleveldb_approximate_sizesPROC leveldb_approximate_sizes = <PFNleveldb_approximate_sizesPROC> get_function(lib_path, b"leveldb_approximate_sizes")
...
cdef PFNleveldb_compact_rangePROC leveldb_compact_range = <PFNleveldb_compact_rangePROC> get_function(lib_path, b"leveldb_compact_range")
...
cdef PFNleveldb_repair_dbPROC leveldb_repair_db = <PFNleveldb_repair_dbPROC> get_function(lib_path, b"leveldb_repair_db")

ctypedef void (*PFNleveldb_iter_destroyPROC)(leveldb_iterator_t * iter)
cdef PFNleveldb_iter_destroyPROC leveldb_iter_destroy = <PFNleveldb_iter_destroyPROC> get_function(lib_path, b"leveldb_iter_destroy")

ctypedef unsigned char (*PFNleveldb_iter_validPROC)(const leveldb_iterator_t * iter)
cdef PFNleveldb_iter_validPROC leveldb_iter_valid = <PFNleveldb_iter_validPROC> get_function(lib_path, b"leveldb_iter_valid")

ctypedef void (*PFNleveldb_iter_seek_to_firstPROC)(leveldb_iterator_t * iter)
cdef PFNleveldb_iter_seek_to_firstPROC leveldb_iter_seek_to_first = <PFNleveldb_iter_seek_to_firstPROC> get_function(lib_path, b"leveldb_iter_seek_to_first")

ctypedef void (*PFNleveldb_iter_seek_to_lastPROC)(leveldb_iterator_t * iter)
cdef PFNleveldb_iter_seek_to_lastPROC leveldb_iter_seek_to_last = <PFNleveldb_iter_seek_to_lastPROC> get_function(lib_path, b"leveldb_iter_seek_to_last")

ctypedef void (*PFNleveldb_iter_seekPROC)(leveldb_iterator_t * iter, const char * k, size_t klen)
cdef PFNleveldb_iter_seekPROC leveldb_iter_seek = <PFNleveldb_iter_seekPROC> get_function(lib_path, b"leveldb_iter_seek")

ctypedef void (*PFNleveldb_iter_nextPROC)(leveldb_iterator_t * iter)
cdef PFNleveldb_iter_nextPROC leveldb_iter_next = <PFNleveldb_iter_nextPROC> get_function(lib_path, b"leveldb_iter_next")

ctypedef void (*PFNleveldb_iter_prevPROC)(leveldb_iterator_t * iter)
cdef PFNleveldb_iter_prevPROC leveldb_iter_prev = <PFNleveldb_iter_prevPROC> get_function(lib_path, b"leveldb_iter_prev")

ctypedef const char * (*PFNleveldb_iter_keyPROC)(const leveldb_iterator_t * iter, size_t * klen)
cdef PFNleveldb_iter_keyPROC leveldb_iter_key = <PFNleveldb_iter_keyPROC> get_function(lib_path, b"leveldb_iter_key")

ctypedef const char * (*PFNleveldb_iter_valuePROC)(const leveldb_iterator_t * iter, size_t * vlen)
cdef PFNleveldb_iter_valuePROC leveldb_iter_value = <PFNleveldb_iter_valuePROC> get_function(lib_path, b"leveldb_iter_value")

ctypedef void (*PFNleveldb_iter_get_errorPROC)(const leveldb_iterator_t * iter, char** errptr)
cdef PFNleveldb_iter_get_errorPROC leveldb_iter_get_error = <PFNleveldb_iter_get_errorPROC> get_function(lib_path, b"leveldb_iter_get_error")

ctypedef leveldb_writebatch_t * (*PFNleveldb_writebatch_createPROC)()
cdef PFNleveldb_writebatch_createPROC leveldb_writebatch_create = <PFNleveldb_writebatch_createPROC> get_function(lib_path, b"leveldb_writebatch_create")

ctypedef void (*PFNleveldb_writebatch_destroyPROC)(leveldb_writebatch_t * b)
cdef PFNleveldb_writebatch_destroyPROC leveldb_writebatch_destroy = <PFNleveldb_writebatch_destroyPROC> get_function(lib_path, b"leveldb_writebatch_destroy")

ctypedef void (*PFNleveldb_writebatch_clearPROC)(leveldb_writebatch_t * b)
cdef PFNleveldb_writebatch_clearPROC leveldb_writebatch_clear = <PFNleveldb_writebatch_clearPROC> get_function(lib_path, b"leveldb_writebatch_clear")

ctypedef void (*PFNleveldb_writebatch_putPROC)(leveldb_writebatch_t * b, const char * key, size_t klen, const char * val, size_t vlen)
cdef PFNleveldb_writebatch_putPROC leveldb_writebatch_put = <PFNleveldb_writebatch_putPROC> get_function(lib_path, b"leveldb_writebatch_put")

ctypedef void (*PFNleveldb_writebatch_deletePROC)(leveldb_writebatch_t * b, const char * key, size_t klen)
cdef PFNleveldb_writebatch_deletePROC leveldb_writebatch_delete = <PFNleveldb_writebatch_deletePROC> get_function(lib_path, b"leveldb_writebatch_delete")
...
cdef PFNleveldb_options_createPROC leveldb_options_create = <PFNleveldb_options_createPROC> get_function(lib_path, b"leveldb_options_create")

ctypedef void (*PFNleveldb_options_destroyPROC)(leveldb_options_t * options)
cdef PFNleveldb_options_destroyPROC leveldb_options_destroy = <PFNleveldb_options_destroyPROC> get_function(lib_path, b"leveldb_options_destroy")
...
cdef PFNleveldb_options_set_filter_policyPROC leveldb_options_set_filter_policy = <PFNleveldb_options_set_filter_policyPROC> get_function(lib_path, b"leveldb_options_set_filter_policy")

ctypedef void (*PFNleveldb_options_set_create_if_missingPROC)(leveldb_options_t * options, unsigned char v)
cdef PFNleveldb_options_set_create_if_missingPROC leveldb_options_set_create_if_missing = <PFNleveldb_options_set_create_if_missingPROC> get_function(lib_path, b"leveldb_options_set_create_if_missing")

ctypedef void (*PFNleveldb_options_set_error_if_existsPROC)(leveldb_options_t * options, unsigned char v)
cdef PFNleveldb_options_set_error_if_existsPROC leveldb_options_set_error_if_exists = <PFNleveldb_options_set_error_if_existsPROC> get_function(lib_path, b"leveldb_options_set_error_if_exists")

ctypedef void (*PFNleveldb_options_set_paranoid_checksPROC)(leveldb_options_t * options, unsigned char v)
cdef PFNleveldb_options_set_paranoid_checksPROC leveldb_options_set_paranoid_checks = <PFNleveldb_options_set_paranoid_checksPROC> get_function(lib_path, b"leveldb_options_set_paranoid_checks")
...
cdef PFNleveldb_options_set_write_buffer_sizePROC leveldb_options_set_write_buffer_size = <PFNleveldb_options_set_write_buffer_sizePROC> get_function(lib_path, b"leveldb_options_set_write_buffer_size")

ctypedef void (*PFNleveldb_options_set_max_open_filesPROC)(leveldb_options_t * options, int n)
cdef PFNleveldb_options_set_max_open_filesPROC leveldb_options_set_max_open_files = <PFNleveldb_options_set_max_open_filesPROC> get_function(lib_path, b"leveldb_options_set_max_open_files")

ctypedef void (*PFNleveldb_options_set_cachePROC)(leveldb_options_t * options, leveldb_cache_t * c)
cdef PFNleveldb_options_set_cachePROC leveldb_options_set_cache = <PFNleveldb_options_set_cachePROC> get_function(lib_path, b"leveldb_options_set_cache")

ctypedef void (*PFNleveldb_options_set_block_sizePROC)(leveldb_options_t * options, size_t s)
cdef PFNleveldb_options_set_block_sizePROC leveldb_options_set_block_size = <PFNleveldb_options_set_block_sizePROC> get_function(lib_path, b"leveldb_options_set_block_size")
...
cdef PFNleveldb_options_set_compressionPROC leveldb_options_set_compression = <PFNleveldb_options_set_compressionPROC> get_function(lib_path, b"leveldb_options_set_compression")
...
cdef PFNleveldb_filterpolicy_destroyPROC leveldb_filterpolicy_destroy = <PFNleveldb_filterpolicy_destroyPROC> get_function(lib_path, b"leveldb_filterpolicy_destroy")

ctypedef leveldb_filterpolicy_t * (*PFNleveldb_filterpolicy_create_bloomPROC)(int bits_per_key)
cdef PFNleveldb_filterpolicy_create_bloomPROC leveldb_filterpolicy_create_bloom = <PFNleveldb_filterpolicy_create_bloomPROC> get_function(lib_path, b"leveldb_filterpolicy_create_bloom")

ctypedef leveldb_readoptions_t * (*PFNleveldb_readoptions_createPROC)()
cdef PFNleveldb_readoptions_createPROC leveldb_readoptions_create = <PFNleveldb_readoptions_createPROC> get_function(lib_path, b"leveldb_readoptions_create")

ctypedef void (*PFNleveldb_readoptions_destroyPROC)(leveldb_readoptions_t * options)
cdef PFNleveldb_readoptions_destroyPROC leveldb_readoptions_destroy = <PFNleveldb_readoptions_destroyPROC> get_function(lib_path, b"leveldb_readoptions_destroy")

ctypedef void (*PFNleveldb_readoptions_set_verify_checksumsPROC)(leveldb_readoptions_t * options, unsigned char v)
cdef PFNleveldb_readoptions_set_verify_checksumsPROC leveldb_readoptions_set_verify_checksums = <PFNleveldb_readoptions_set_verify_checksumsPROC> get_function(lib_path, b"leveldb_readoptions_set_verify_checksums")

ctypedef void (*PFNleveldb_readoptions_set_fill_cachePROC)(leveldb_readoptions_t * options, unsigned char v)
cdef PFNleveldb_readoptions_set_fill_cachePROC leveldb_readoptions_set_fill_cache = <PFNleveldb_readoptions_set_fill_cachePROC> get_function(lib_path, b"leveldb_readoptions_set_fill_cache")

ctypedef void (*PFNleveldb_readoptions_set_snapshotPROC)(leveldb_readoptions_t * options, const leveldb_snapshot_t *)
cdef PFNleveldb_readoptions_set_snapshotPROC leveldb_readoptions_set_snapshot = <PFNleveldb_readoptions_set_snapshotPROC> get_function(lib_path, b"leveldb_readoptions_set_snapshot")

ctypedef leveldb_writeoptions_t * (*PFNleveldb_writeoptions_createPROC)()
cdef PFNleveldb_writeoptions_createPROC leveldb_writeoptions_create = <PFNleveldb_writeoptions_createPROC> get_function(lib_path, b"leveldb_writeoptions_create")

ctypedef void (*PFNleveldb_writeoptions_destroyPROC)(leveldb_writeoptions_t * options)
cdef PFNleveldb_writeoptions_destroyPROC leveldb_writeoptions_destroy = <PFNleveldb_writeoptions_destroyPROC> get_function(lib_path, b"leveldb_writeoptions_destroy")

ctypedef void (*PFNleveldb_writeoptions_set_syncPROC)(leveldb_writeoptions_t * options, unsigned char v)
cdef PFNleveldb_writeoptions_set_syncPROC leveldb_writeoptions_set_sync = <PFNleveldb_writeoptions_set_syncPROC> get_function(lib_path, b"leveldb_writeoptions_set_sync")

ctypedef leveldb_cache_t * (*PFNleveldb_cache_create_lruPROC)(size_t capacity)
cdef PFNleveldb_cache_create_lruPROC leveldb_cache_create_lru = <PFNleveldb_cache_create_lruPROC> get_function(lib_path, b"leveldb_cache_create_lru")

ctypedef void (*PFNleveldb_cache_destroyPROC)(leveldb_cache_t * cache)
cdef PFNleveldb_cache_destroyPROC leveldb_cache_destroy = <PFNleveldb_cache_destroyPROC> get_function(lib_path, b"leveldb_cache_destroy")
...
cdef PFNleveldb_freePROC leveldb_free = <PFNleveldb_freePROC> get_function(lib_path, b"leveldb_free")
